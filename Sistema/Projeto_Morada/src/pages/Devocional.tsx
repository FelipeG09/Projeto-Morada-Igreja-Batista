  ...
  return (
    <div>
      <Hero
        ...
        imageUrl="https://github.com/FelipeG09/Projeto-Morada-Igreja-Batista/blob/main/imagens/Devotional-Banner.png?raw=true"
      />
              ...
              <div className="mb-6 flex items-center justify-between">
                <button
                  ...
                  className={`btn-outline ${
                    currentIndex >= sortedDevotionals.length - 1
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-700 mb-8">
              ...
              e-mail todas as manhãs. Uma forma simples de iniciar seu dia com
              inspiração e reflexão bíblica.
            </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-xs text-gray-500 mt-3">
                Respeitamos sua privacidade. Você pode cancelar sua inscrição a
                qualquer momento.
              </p>
            </div>
          </div>
